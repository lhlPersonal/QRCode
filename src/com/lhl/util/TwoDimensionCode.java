...
public class TwoDimensionCode {
	...
	public static void main(String[] args) {
		String imgPath = "E:\\apache-tomcat-8.0.12\\me-webapps\\QRCode\\img\\002.png";
		String encoderContent = "http://localhost:8080/QrCode/Login.html";
		TwoDimensionCode handler = new TwoDimensionCode();
		handler.encoderQRCode(encoderContent, imgPath, "png");

		/*
		 * ln("========encoder success"); String decoderContent =
		 * handler.decoderQRCode(imgPath); ln("����������£�");
		 * ln(decoderContent); ln("========decoder success!!!");
		 */
	}
}